...
# Ux: longitudinal velocity, Uy: lateral velocity, r: yaw rate, delta: steering angle, param: vehicle parameters
...
# alpha: slip angle, Fz: normal load, Fx: longitudinal force, C_alpha: cornering stiffness, mu: friction coefficient
